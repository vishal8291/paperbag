      ...
      <div style={{ background: "linear-gradient(135deg,#1a3a2a 0%,#2d6a4f 100%)", padding: "90px 24px 80px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <motion.div {...fade()}>
          ...
          <div style={{ display:"flex", gap:"12px", justifyContent:"center", flexWrap:"wrap" }}>
            <Link href={`/store/${slug}/products`} style={{ background:"#c9a84c", color:"#1a3a2a", padding:"13px 28px", borderRadius:"10px", fontWeight:800, fontSize:"15px", textDecoration:"none" }}>
              Shop Now →
            </Link>
            <Link href={`/store/${slug}/contact`} style={{ background:"rgba(255,255,255,0.1)", color:"#faf7f2", padding:"13px 28px", borderRadius:"10px", fontWeight:700, fontSize:"15px", textDecoration:"none", border:"1px solid rgba(255,255,255,0.2)" }}>
              Get in Touch
            </Link>
          </div>
        </motion.div>
